...
const CartItemsDetailCheckoutMobile = ({ isOpen, onClose }) => {
    const {
        cartItems,
        updateQty,
        toggleSingle,
        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    {/* Bottom Modal */}
                    <motion.div
                        className="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl z-[999999999] shadow-xl"
                        initial={{ y: "100%" }}
                        animate={{ y: 0 }}
                        exit={{ y: "100%" }}
                    ...
                    >
                        ...
                        <div className="px-4 py-3 flex items-center justify-between border-b border-gray-200">
                            ...
                            <p className="text-[17px] font-semibold text-black">Items Detail</p>
...
export default CartItemsDetailCheckoutMobile;
