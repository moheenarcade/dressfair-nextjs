...
const ShareCartBottomModal = ({ isOpen, onClose }) => {
    ...
    const handleShare = () => {
        ...
        console.log("Selected to Share:", selectedItems);
        // Later: copy link / share to WhatsApp / generate cart link
    };
                ...
                <>
                    ...
                    >
                        ...
                        <div className="px-4 py-3 flex items-center justify-between border-b border-gray-200">
                            ...
                            <p className="text-[17px] font-semibold text-black">Share Cart</p>
                        ...
                        <div className="max-h-[70vh] overflow-y-auto px-4 pb-20 pt-6 flex flex-col gap-4">
                            ...
                            <div className="fixed bottom-0 bg-white py-2 px-2 z-[999999] w-full right-0 left-0 border-t border-t-gray-200">
                                <div className="flex items-center justify-between">
                                    ...
                                    >
                                        {allSelected
                                            ? <BsCheckCircleFill className="text-2xl text-[#222]" />
                                            : <GoCircle className="text-2xl text-black" />}
                                        <p className="text-[16px] text-[#222] font-[600]">All</p>
                                    </div>

                                    <button
                                        className="bg-[#fb7701] text-white text-sm font-[600] rounded-full py-2 px-4"
                                        onClick={handleShare}
                                    >
                                        Share now  ({cartItems.filter(item => item.selected).length})
                                    </button>
                                </div>
                            </div>
                        </div>
...
export default ShareCartBottomModal;
