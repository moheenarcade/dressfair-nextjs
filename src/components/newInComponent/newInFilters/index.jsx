...
const categories = [
    "Recommended", "Men's Fashion", "Women's Fashion", "Electronics"
...
const NewInFilters = () => {
    ...
    return (
        <div>
            ...
            <div className="block xl:hidden px-2">
                <ProductCardMobile products={filteredProducts} />
            </div>

            <div className="flex justify-center items-center pt-6">
                <button className='flex items-center gap-2 justify-center py-2 lg:py-3 px-6 lg:px-12 font-semibold text-md transition-all duration-300 ease-in-out hover:scale-[1.02] hover:bg-[#fb6d01] bg-[#fb7701] text-white rounded-full'>
