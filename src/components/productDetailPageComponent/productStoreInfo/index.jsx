    ...
    return (
        <div className='py-12'>
            <div className="flex items-center gap-4">
                <div className="">
                    <Image className="rounded-full w-24 h-24" width={100} height={100} src="/deals-product4.avif" alt="product store logo" />
                </div>
                <div className="">
                    <h2 className='text-[#222] text-[22px] font-semibold'>Dressfair Shoes</h2>
                    <div className="flex items-center gap-3">
                        <p className='text-[#000] text-[14px] font-semibold'>
                            1.1K+
                            <span className='text-[#888] ml-1 text-[14px] font-normal'>
                                Followers
                            </span>
                        </p>
