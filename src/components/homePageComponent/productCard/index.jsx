...
//   // 🌀 Each card gets its own message index and random interval
//   const [activeMessageIndex, setActiveMessageIndex] = useState(
//     Math.floor(Math.random() * messages.length)
//   );

//   useEffect(() => {
//     const randomInterval = Math.floor(Math.random() * 8000) + 7000; // 4–9 seconds random
...
//         {/* 💫 Animated promotional text (per product, random timing) */}
//         <div className="card-promotional-content overflow-hidden h-[22px]">
