...
//                 {/* Filter Icon Button (No dropdown) */}
//                 <button className="flex items-center h-[40px] cursor-pointer gap-1 rounded-full py-2 px-3 bg-[#f6f6f6] text-[#555] text-[14px] hover:bg-[#eaeaea] hover:text-black transition-all">
...
const CategoryFilters = () => {
    ...
    return (
        <>
            <div ref={dropdownRef} className="relative w-full">
                <div id="filter-scroll" className="flex items-center gap-2 px-2 relative w-full">
                    {/* Filter Icon Button - Now opens sidebar */}
                    <button 
